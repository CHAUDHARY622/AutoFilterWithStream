...
BOT_TOKEN = environ['6755707899:AAGa-Vd7zOyG0ZBG_zf_Lqq6Rwdvf7Z-qGE']
...
reqst_channel = environ.get('-1001634318664')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'False')), False)

# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://Cartoon1:Cartoon1@cartoon1.wx9ipj4.mongodb.net/?retryWrites=true&w=majority')
DATABASE_NAME = environ.get('Cartoon1')
...
SHORTLINK_URL = environ.get('shrinkme.io')
SHORTLINK_API = environ.get('7c5800f5c1dc157c7cb9dfd2c3645bdfd93dfc93')
...
INDEX_REQ_CHANNEL = int(environ.get('-1002092271327'))
